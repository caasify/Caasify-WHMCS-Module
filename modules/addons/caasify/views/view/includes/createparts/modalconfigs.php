<!-- Config  modal -->
<div class="modal fade modal-lg" id="configModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="configModalLabel" aria-hidden="false" ref="configModal">
    <div class="modal-dialog modal-dialog-top" style="max-width: 550px !important; padding-top: 150px">
