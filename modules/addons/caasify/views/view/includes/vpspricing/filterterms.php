        ...
        <div class="d-flex flex-row justify-content-between align-items-center pb-2">
            <div class="">
                <p class="fs-6 fw-medium p-0 m-0 py-1">
                    {{ lang('Filters') }}
                    <span v-if="plansAreLoading" class="ms-2 text-primary small">
...
<div class="row">
    <div class="col-12">
        ...
        <div class="row p-0" v-if="FilterTermsAreLoaded">
            <div class="text-start px-0" v-for="(filter, index) in sortedFiltersTerm" :key="index" :id="'accordionPanel' + index">
